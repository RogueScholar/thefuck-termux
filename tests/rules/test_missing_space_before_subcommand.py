...
from thefuck.rules.missing_space_before_subcommand import get_new_command
from thefuck.rules.missing_space_before_subcommand import match
...
@pytest.mark.parametrize("script", ["gitbranch", "ls-la", "npminstall"])
