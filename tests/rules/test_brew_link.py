...
from thefuck.rules.brew_link import get_new_command
from thefuck.rules.brew_link import match
...
@pytest.mark.parametrize("script",
                         ["brew link coreutils", "brew ln coreutils"])
