...
from thefuck.rules.ssh_known_hosts import get_new_command
from thefuck.rules.ssh_known_hosts import match
from thefuck.rules.ssh_known_hosts import side_effect
...
Host key verification failed.""".format(
        path, "98.765.432.321"
    )
